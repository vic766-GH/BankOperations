from utils import get_operations, transaction_tu_rub
...
#     print(f"Обработано {len(results)} транзакций")
    ...
    transaction_amount = "48150.39"
    print(convert_currency(transaction_date, "RUB", "EUR", transaction_amount))
    ...
    for transaction in transactions:
        print(transaction_tu_rub(transaction))

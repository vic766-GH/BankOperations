...
from src.trans_operations import (get_variant, process_bank_operations,
                                  source_select)


@pytest.mark.parametrize(
    "file,list_dict,selected,answers,result",
    [
        (
            "",
        ...
        (
            "test_transactions",
            "test_transactions_dict_json",
            ["EXECUTED", "CANCELED", "PENDING"],
            ["1", ["EXECUTED", "CANCELED", "PENDING"], "", "", "", "", ""],
            "test_transactions_dict_json",
        ),
        (
            "test_transactions",
            ...
            ["EXECUTED", "CANCELED", "PENDING"],
            ["2", ["EXECUTED", "CANCELED", "PENDING"], "", "", "", "", ""],
            "test_transactions_dict_csv",
        ),
        (
            "test_transactions",
            "test_transactions_dict_xlsx",
            ["EXECUTED", "CANCELED", "PENDING"],
            ["3", ["EXECUTED", "CANCELED", "PENDING"], "", "", "", "да", "открытие"],
            "test_transactions_dict_xlsx_search",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("test_transactions_dict_csv", ["EXECUTED"], {"EXECUTED": 10}),
        (
            "test_transactions_dict_csv",
            ["EXECUTED", "PENDING"],

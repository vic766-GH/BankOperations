...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "700079228966361",
            "",
        ),  # некорректные данные - короткая строка - менее 16 символов
        (
            "70007922896O6361",
            "",
        ),  # некорректные данные - присутствует не цифра - вместо 0 - O
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "736541084301358",
            "",
        ),  # некорректные данные - короткая строка - менее 20 символов
        (
            "70007922896O6361",
            "",
        ),  # некорректные данные - присутствует не цифра - вместо 0 - O
